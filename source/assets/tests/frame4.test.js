...
describe('initFrameFour', () => {
    ...
    it('should initialize frame four functionality', () => {
        ...
        expect(document.getElementById('frame4-layout').style.display).toBe('none');  
        ...
        expect(document.getElementById('frame5-layout').innerHTML).toBe('Frame 5 Template');  
        
        // frame5-layout should have display: flex
        expect(document.getElementById('frame5-layout').style.display).toBe('flex');  
        ...
        expect(mockAudioConstructor().src).toBe('./assets/audios/drinking_tea.mp3');  
